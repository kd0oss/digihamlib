...
public:
    ...
    QQueue<int16_t> m_micData;

    void init(QString callsign, uint32_t dmrid, uint16_t nxdnid, char module, QString refname, QString host, int port, bool ipv6, QString vocoder, QString modem, bool mdirect);
